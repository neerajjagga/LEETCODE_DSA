    ...
    string numberToWords(int num) {
        ...
        for(auto it: mp) {
            if(num >= it.first) {
                ...
                // this if statement is used to find how many hundereds or millions or billions etc
                // this if condition is used because we say that one hundered, one thousand not one fifty or one twenty
                if(num >= 100) {
